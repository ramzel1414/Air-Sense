        ...
        <div class="row">
          <div class="col-2 d-flex justify-content-between w-100">
            ...
            <div class="btns">
              ...
              {{-- <button id="expPM25" class="btn btn-outline-secondary btn-icon-text me-2 mb-2 mb-md-0">Download CSV</button> --}}
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" id="expPM25">Hourly</a>
                  <a class="dropdown-item" id="expPM25Daily">Daily</a>
                  <a class="dropdown-item" id="expPM25Monthly">Monthly</a>
                </div>
              </div>
