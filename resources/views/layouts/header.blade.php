...
<div class="user-header d-flex justify-content-between align-items-center py-2 px-3">
    ...
    <div class="right d-flex align-items-center">
      <a href="{{route('index')}}" class="d-flex align-items-center text-gray-600 hover:text-gray-900 focus:outline-gray-500 p-1 focus:outline focus:outline-2 focus:rounded-sm">
      ...
      <ul class="nav">
        <li class="nav-item">
          <a href="{{route('index')}}" class="p-1 mx-2 nav-link">
            Home
          </a>
        </li>
        <li>
    ...
    <div class="left">
      ...
      <div>
        @auth
          <a href="{{ route('admin.dashboard')}}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-gray-500">Back</a>
        @else
