...
class MonthlyO3Controller extends Controller
{
    public function index() {
        ...
        $fpdf->Cell(0, 10, 'CY 2024-2025 Monthly Assessment Report from AirSense IoT Monitoring Device', 0, 1, 'C');
        $fpdf->Cell(0, 0, 'O3 Ambient Air Quality Monitoring Station', 0, 1, 'C');
        $fpdf->Ln(10);
        ...
        $fpdf->Cell(100, 5, 'To determine the concentration level of O3', 'B', 1);
