...
class WeeklyO3Controller extends Controller
{
    public function index() {
        ...
        $fpdf->Cell(0, 10, 'CY 2024-2025 Weekly Assessment Report from AirSense IoT Monitoring Device', 0, 1, 'C');
